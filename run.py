...
#cmd = \
#"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h test-drive.airavata.org registerComputeResource \"computeResourceModel.ttypes.ComputeResourceDescription(hostName='test-drive.airavata.org', resourceDescription='TestDrive', ipAddresses=None, hostAliases=None, )\""
cmd = \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 registerComputeResource \"computeResourceModel.ttypes.ComputeResourceDescription(hostName='gw111.iu.xsede.org', resourceDescription='DevTest', ipAddresses=None, hostAliases=None, )\""
...
cmd = \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 addLocalSubmissionDetails %s \"1\" \"computeResourceModel.ttypes.LOCALSubmission(resourceJobManager=computeResourceModel.ttypes.ResourceJobManager(resourceJobManagerType=computeResourceModel.ttypes.ResourceJobManagerType.FORK,pushMonitoringEndpoint=None,jobManagerBinPath=None,jobManagerCommands=None))\"" % (computeresource,)
print "cmd (%s)" % cmd
...
cmd =  \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 registerApplicationModule \"applicationDeploymentModel.ttypes.ApplicationModule(appModuleId=None, appModuleName='test1name', appModuleVersion='1.0', appModuleDescription='test1desc')\""
...
cmd = \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 registerApplicationDeployment \"applicationDeploymentModel.ttypes.ApplicationDeploymentDescription(appDeploymentId=None, appModuleId=%s, computeHostId=%s, executablePath='%s',appDeploymentDescription='%s description')\"" % (appmodid, computeresource,remoteprogram,remoteprogram)
print "cmd (%s)" % cmd
...
cmd = \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 registerApplicationInterface \"applicationInterfaceModel.ttypes.ApplicationInterfaceDescription(applicationInterfaceId=None, applicationName='datetest', applicationModules=[%s,],applicationDescription='appdescription',applicationInputs=[applicationInterfaceModel.ttypes.InputDataObjectType(userFriendlyDescription='A test string to testapp', name='Input_to_testapp', value='%s', applicationArgument='', standardInput=False, type=0, metaData=None)],applicationOutputs=[applicationInterfaceModel.ttypes.OutputDataObjectType(type=0, name='testapp_Output', value='5')])\"" % (appmodid,argstring)
print "cmd (%s)" % cmd
...
cmd = \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 createProject \"workspaceModel.ttypes.Project(sharedUsers=None, name='test1', projectID='DEFAULT', sharedGroups=None, creationTime=None, owner='kenneth1', description=None)\""
...
cmd = \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 createExperiment \"experimentModel.ttypes.Experiment(projectID=%s,userName='kenneth1',name='dateexperiment',applicationId=%s,userConfigurationData=experimentModel.ttypes.UserConfigurationData(advanceInputDataHandling=None, overrideManualScheduledParams=False, throttleResources=False, airavataAutoSchedule=False,computationalResourceScheduling=experimentModel.ttypes.ComputationalResourceScheduling(computationalProjectAccount='test', totalPhysicalMemory=1, resourceHostId=%s, numberOfThreads=1, wallTimeLimit=1, jobStartTime=-191358653, nodeCount=1, totalCPUCount=1, queueName='normal'),shareExperimentPublicly=False, qosParams=None, advanceOutputDataHandling=None),experimentInputs=[applicationInterfaceModel.ttypes.InputDataObjectType(userFriendlyDescription='A test string to testapp', name='Input_to_testapp', value='%s', applicationArgument='', standardInput=False, type=0, metaData=None)],experimentOutputs=[applicationInterfaceModel.ttypes.OutputDataObjectType(name='dateout',value='5'),],description=None,workflowNodeDetailsList=[experimentModel.ttypes.WorkflowNodeDetails(taskDetailsList=[experimentModel.ttypes.TaskDetails(applicationId=%s,jobDetailsList=[experimentModel.ttypes.JobDetails(jobDescription='datejob'),]),]),])\"" % (projectid,appintid,computeresource,argstring,appintid)
expid = os.popen(cmd).read().strip()
print "expid = (%s)" % expid

cmd = \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 validateExperiment %s" % (expid,)
print "cmd (%s)" % cmd
...
cmd = \
"/media/scigap/scigap/0.14.RC2/airavata-0.14/airavata-api/thrift-interface-descriptions/gen-py/apache/airavata/api/Airavata-remote -h gw111.iu.xsede.org:9930 launchExperiment %s runme" % (expid,)
print "cmd (%s)" % cmd
expout = os.popen(cmd).read()
print "expout = (%s)" % expout
